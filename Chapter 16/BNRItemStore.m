...
- (void)moveItemAtIndex:(int)from toIndex:(int)to
{
    ...
    // Compute new orderValue for the object that was moved
...
- (NSArray *)allAssetTypes
{
    ...
    if ([allAssetTypes count] == 0) {
        ...
        [type setValue:@"Pug" forKey:@"label"];
        [allAssetTypes addObject:type];
        
        type = [NSEntityDescription insertNewObjectForEntityForName:@"BNRAssetType" inManagedObjectContext:context];
        [type setValue:@"French Bulldog" forKey:@"label"];
        [allAssetTypes addObject:type];
        
        type = [NSEntityDescription insertNewObjectForEntityForName:@"BNRAssetType" inManagedObjectContext:context];
        [type setValue:@"Bulldog" forKey:@"label"];
